...
/-
This file: calculus, differentiation and integration.

Thanks to Floris van Doorn
https://github.com/fpvandoorn/LeanCourse24/blob/master/LeanCourse/Lectures/Lecture9Before.lean
-/
...
-- Doesn't work in this version of mathlib
